package com.ciptadana.mkbd_gen.config.database;

import com.ciptadana.mkbd_gen.config.database.jpa.HibernateProperties;
import com.ciptadana.mkbd_gen.config.database.jpa.OracleJpaProperties;
...
@EnableJpaRepositories(
        basePackages = "com.ciptadana.mkbd_gen.database.oracle.repository.jpa",
...
public class OracleDBConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean = builder
                ...
                .packages("com.ciptadana.mkbd_gen.database.oracle")
